...
namespace Store_Snitch
{
  ...
  sealed partial class App : Application
  {
    ...
    public async void WriteMessage(string strMessage)
    {
    ...
    void App_UnhandledException(object sender, UnhandledExceptionEventArgs e)
    {
      ...
      if (e.Exception.GetType() == typeof(System.ArgumentException)) {
        WriteMessage(string.Format("UnhandledException - Continuing - {0}", e.Exception.ToString()));
        e.Handled = true;
      } else { // Keep Running the app
